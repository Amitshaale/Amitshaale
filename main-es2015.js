...
/* harmony default export */ __webpack_exports__["default"] = ("<div [class]=\"'theme-wrapper ' + (theme$ | async)\">\n    <router-outlet></router-outlet>\n</div>");
...
const routes = [
    ...
    // },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | auth-auth-module */ "auth-auth-module").then(__webpack_require__.bind(null, /*! ./auth/auth.module */ "./src/app/auth/auth.module.ts")).then(mod => mod.AuthModule)
    },
    {
        path: '',
        loadChildren: () => __webpack_require__.e(/*! import() | products-products-module */ "products-products-module").then(__webpack_require__.bind(null, /*! ./products/products.module */ "./src/app/products/products.module.ts")).then(mod => mod.ProductsModule)
    },
    // {
    //   path: '',
...
let AppComponent = class AppComponent {
    constructor(store, storageService) {
        ...
        this.logo = __webpack_require__(/*! ../assets/img/logo.png */ "./src/assets/img/logo.png");
    }
    ngOnInit() {
        this.storageService.testLocalStorage();
        this.isAuthenticated$ = this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["select"])(_core_core_module__WEBPACK_IMPORTED_MODULE_3__["selectIsAuthenticated"]));
        this.theme$ = this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["select"])(_core_core_module__WEBPACK_IMPORTED_MODULE_3__["selectEffectiveTheme"]));
    }
    onChangeTheme($event) {
        console.log($event.checked);
        if ($event.checked === true) {
            const theme = 'BLACK-THEME';
...
/* harmony import */ var _shared_interceptor_auth_interceptor__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./shared/interceptor/auth-interceptor */ "./src/app/shared/interceptor/auth-interceptor.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        ...
        providers: [_shared_seo_seo_service__WEBPACK_IMPORTED_MODULE_9__["SeoService"],
            {
                provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HTTP_INTERCEPTORS"],
                useClass: _shared_interceptor_auth_interceptor__WEBPACK_IMPORTED_MODULE_12__["AuthInterceptor"],
                multi: true
            }
        ],
...
let AnimationsService = AnimationsService_1 = class AnimationsService {
    constructor() {
...
/* harmony import */ var _animations_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./animations.service */ "./src/app/core/animations/animations.service.ts");
...
const STEPS_ALL = [
    ...
    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["query"])(':enter .' + ROUTE_ANIMATIONS_ELEMENTS, Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["style"])({ opacity: 0 }), {
        optional: true
    }),
    ...
    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["query"])(':enter .' + ROUTE_ANIMATIONS_ELEMENTS, Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["stagger"])(75, [
        Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["style"])({ transform: 'translateY(10%)', opacity: 0 }),
        Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["animate"])('0.5s ease-in-out', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["style"])({ transform: 'translateY(0%)', opacity: 1 }))
    ]), { optional: true })
];
const STEPS_NONE = [];
...
const routeAnimations = Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["trigger"])('routeAnimations', [
    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["transition"])(isRouteAnimationsAll, STEPS_ALL),
    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["transition"])(isRouteAnimationsNone, STEPS_NONE),
    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["transition"])(isRouteAnimationsPage, STEPS_PAGE),
...
let AuthGuardService = class AuthGuardService {
    constructor(store, router, restApi) {
        this.store = store;
        this.router = router;
...
const authLogin = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Auth] Login');
const authLogout = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Auth] Logout');
...
/* harmony import */ var _auth_actions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./auth.actions */ "./src/app/core/auth/auth.actions.ts");
...
let AuthEffects = class AuthEffects {
    constructor(actions$, localStorageService, router) {
        ...
        this.router = router;
        this.login = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["ofType"])(_auth_actions__WEBPACK_IMPORTED_MODULE_6__["authLogin"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(() => this.localStorageService.setItem(AUTH_KEY, { isAuthenticated: true }))), { dispatch: false });
        this.logout = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["ofType"])(_auth_actions__WEBPACK_IMPORTED_MODULE_6__["authLogout"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(() => {
...
const reducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["on"])(_auth_actions__WEBPACK_IMPORTED_MODULE_1__["authLogin"], state => (Object.assign({}, state, { isAuthenticated: true }))), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["on"])(_auth_actions__WEBPACK_IMPORTED_MODULE_1__["authLogout"], state => (Object.assign({}, state, { isAuthenticated: false }))));
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm2015/store.js");
/* harmony import */ var _core_state__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../core.state */ "./src/app/core/core.state.ts");



const selectAuth = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(_core_state__WEBPACK_IMPORTED_MODULE_2__["selectAuthState"], (state) => state);
const selectIsAuthenticated = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(_core_state__WEBPACK_IMPORTED_MODULE_2__["selectAuthState"], (state) => state.isAuthenticated);
...
let LoggedInAuthGuardService = class LoggedInAuthGuardService {
    constructor(store, router, restApi) {
        this.store = store;
        this.router = router;
        this.restApi = restApi;
...
LoggedInAuthGuardService.ctorParameters = () => [
    { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_3__["Store"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _shared_rest_api_service__WEBPACK_IMPORTED_MODULE_4__["RestApiService"] }
];
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "selectRouterState", function() { return _core_state__WEBPACK_IMPORTED_MODULE_11__["selectRouterState"]; });
...
/* harmony import */ var _auth_auth_selectors__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./auth/auth.selectors */ "./src/app/core/auth/auth.selectors.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "selectAuth", function() { return _auth_auth_selectors__WEBPACK_IMPORTED_MODULE_13__["selectAuth"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "selectIsAuthenticated", function() { return _auth_auth_selectors__WEBPACK_IMPORTED_MODULE_13__["selectIsAuthenticated"]; });

/* harmony import */ var _auth_auth_actions__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./auth/auth.actions */ "./src/app/core/auth/auth.actions.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "authLogin", function() { return _auth_auth_actions__WEBPACK_IMPORTED_MODULE_14__["authLogin"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "authLogout", function() { return _auth_auth_actions__WEBPACK_IMPORTED_MODULE_14__["authLogout"]; });

/* harmony import */ var _auth_auth_guard_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./auth/auth-guard.service */ "./src/app/core/auth/auth-guard.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AuthGuardService", function() { return _auth_auth_guard_service__WEBPACK_IMPORTED_MODULE_15__["AuthGuardService"]; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "TitleService", function() { return _title_title_service__WEBPACK_IMPORTED_MODULE_16__["TitleService"]; });

/* harmony import */ var _animations_route_animations__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./animations/route.animations */ "./src/app/core/animations/route.animations.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "routeAnimations", function() { return _animations_route_animations__WEBPACK_IMPORTED_MODULE_17__["routeAnimations"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ROUTE_ANIMATIONS_ELEMENTS", function() { return _animations_route_animations__WEBPACK_IMPORTED_MODULE_17__["ROUTE_ANIMATIONS_ELEMENTS"]; });

/* harmony import */ var _animations_animations_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./animations/animations.service */ "./src/app/core/animations/animations.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AnimationsService", function() { return _animations_animations_service__WEBPACK_IMPORTED_MODULE_18__["AnimationsService"]; });

/* harmony import */ var _error_handler_app_error_handler_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./error-handler/app-error-handler.service */ "./src/app/core/error-handler/app-error-handler.service.ts");
/* harmony import */ var _router_custom_serializer__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./router/custom-serializer */ "./src/app/core/router/custom-serializer.ts");
/* harmony import */ var _local_storage_local_storage_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./local-storage/local-storage.service */ "./src/app/core/local-storage/local-storage.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "LocalStorageService", function() { return _local_storage_local_storage_service__WEBPACK_IMPORTED_MODULE_21__["LocalStorageService"]; });

/* harmony import */ var _http_interceptors_http_error_interceptor__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./http-interceptors/http-error.interceptor */ "./src/app/core/http-interceptors/http-error.interceptor.ts");
/* harmony import */ var _notifications_notification_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./notifications/notification.service */ "./src/app/core/notifications/notification.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "NotificationService", function() { return _notifications_notification_service__WEBPACK_IMPORTED_MODULE_23__["NotificationService"]; });

/* harmony import */ var _settings_settings_effects__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./settings/settings.effects */ "./src/app/core/settings/settings.effects.ts");
/* harmony import */ var _settings_settings_selectors__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./settings/settings.selectors */ "./src/app/core/settings/settings.selectors.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "selectEffectiveTheme", function() { return _settings_settings_selectors__WEBPACK_IMPORTED_MODULE_25__["selectEffectiveTheme"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "selectSettingsLanguage", function() { return _settings_settings_selectors__WEBPACK_IMPORTED_MODULE_25__["selectSettingsLanguage"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "selectSettingsStickyHeader", function() { return _settings_settings_selectors__WEBPACK_IMPORTED_MODULE_25__["selectSettingsStickyHeader"]; });
...
function HttpLoaderFactory(http) {
    return new _ngx_translate_http_loader__WEBPACK_IMPORTED_MODULE_9__["TranslateHttpLoader"](http, `${_environments_environment__WEBPACK_IMPORTED_MODULE_10__["environment"].i18nPrefix}/assets/i18n/`, '.json');
}
    ...
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        imports: [
            ...
            _ngrx_effects__WEBPACK_IMPORTED_MODULE_6__["EffectsModule"].forRoot([
                ...
                _settings_settings_effects__WEBPACK_IMPORTED_MODULE_24__["SettingsEffects"]
            ]),
            _environments_environment__WEBPACK_IMPORTED_MODULE_10__["environment"].production
                ? []
        ...
        declarations: [],
        providers: [
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HTTP_INTERCEPTORS"], useClass: _http_interceptors_http_error_interceptor__WEBPACK_IMPORTED_MODULE_22__["HttpErrorInterceptor"], multi: true },
            { provide: _angular_core__WEBPACK_IMPORTED_MODULE_2__["ErrorHandler"], useClass: _error_handler_app_error_handler_service__WEBPACK_IMPORTED_MODULE_19__["AppErrorHandler"] },
            { provide: _ngrx_router_store__WEBPACK_IMPORTED_MODULE_4__["RouterStateSerializer"], useClass: _router_custom_serializer__WEBPACK_IMPORTED_MODULE_20__["CustomSerializer"] }
        ],
...
/* harmony import */ var _settings_settings_reducer__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./settings/settings.reducer */ "./src/app/core/settings/settings.reducer.ts");
...
/* harmony import */ var _notifications_notification_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../notifications/notification.service */ "./src/app/core/notifications/notification.service.ts");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm2015/store.js");
/* harmony import */ var _local_storage_local_storage_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../local-storage/local-storage.service */ "./src/app/core/local-storage/local-storage.service.ts");
...
const actionSettingsChangeLanguage = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Settings] Change Language', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const actionSettingsChangeTheme = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Settings] Change Theme', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const actionSettingsChangeAutoNightMode = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Settings] Change Auto Night Mode', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const actionSettingsChangeStickyHeader = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Settings] Change Sticky Header', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const actionSettingsChangeAnimationsPage = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Settings] Change Animations Page', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const actionSettingsChangeAnimationsPageDisabled = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Settings] Change Animations Page Disabled', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const actionSettingsChangeAnimationsElements = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Settings] Change Animations Elements', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const actionSettingsChangeHour = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Settings] Change Hours', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
...
/* harmony import */ var _local_storage_local_storage_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../local-storage/local-storage.service */ "./src/app/core/local-storage/local-storage.service.ts");
/* harmony import */ var _animations_animations_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../animations/animations.service */ "./src/app/core/animations/animations.service.ts");
/* harmony import */ var _title_title_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../title/title.service */ "./src/app/core/title/title.service.ts");
/* harmony import */ var _settings_actions__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./settings.actions */ "./src/app/core/settings/settings.actions.ts");
/* harmony import */ var _settings_selectors__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./settings.selectors */ "./src/app/core/settings/settings.selectors.ts");
...
const INIT = Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["of"])('shaale-init-effect-trigger');
let SettingsEffects = class SettingsEffects {
    constructor(actions$, store, router, overlayContainer, localStorageService, titleService, animationsService, translateService) {
        ...
        this.changeHour = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_5__["createEffect"])(() => Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["interval"])(60000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["mapTo"])(new Date().getHours()), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["map"])(hour => Object(_settings_actions__WEBPACK_IMPORTED_MODULE_13__["actionSettingsChangeHour"])({ hour }))));
        this.persistSettings = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_5__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_5__["ofType"])(_settings_actions__WEBPACK_IMPORTED_MODULE_13__["actionSettingsChangeAnimationsElements"], _settings_actions__WEBPACK_IMPORTED_MODULE_13__["actionSettingsChangeAnimationsPage"], _settings_actions__WEBPACK_IMPORTED_MODULE_13__["actionSettingsChangeAnimationsPageDisabled"], _settings_actions__WEBPACK_IMPORTED_MODULE_13__["actionSettingsChangeAutoNightMode"], _settings_actions__WEBPACK_IMPORTED_MODULE_13__["actionSettingsChangeLanguage"], _settings_actions__WEBPACK_IMPORTED_MODULE_13__["actionSettingsChangeStickyHeader"], _settings_actions__WEBPACK_IMPORTED_MODULE_13__["actionSettingsChangeTheme"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["withLatestFrom"])(this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_4__["select"])(_core_state__WEBPACK_IMPORTED_MODULE_9__["selectSettingsState"]))), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["tap"])(([action, settings]) => {
            console.log(settings);
            this.localStorageService.setItem(SETTINGS_KEY, settings);
        })), { dispatch: false });
        this.updateRouteAnimationType = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_5__["createEffect"])(() => Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["merge"])(INIT, this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_5__["ofType"])(_settings_actions__WEBPACK_IMPORTED_MODULE_13__["actionSettingsChangeAnimationsElements"], _settings_actions__WEBPACK_IMPORTED_MODULE_13__["actionSettingsChangeAnimationsPage"]))).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["withLatestFrom"])(Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["combineLatest"])([
            this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_4__["select"])(_settings_selectors__WEBPACK_IMPORTED_MODULE_14__["selectPageAnimations"])),
            this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_4__["select"])(_settings_selectors__WEBPACK_IMPORTED_MODULE_14__["selectElementsAnimations"]))
        ])), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["tap"])(([action, [pageAnimations, elementsAnimations]]) => this.animationsService.updateRouteAnimationType(pageAnimations, elementsAnimations))), { dispatch: false });
        this.updateTheme = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_5__["createEffect"])(() => Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["merge"])(INIT, this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_5__["ofType"])(_settings_actions__WEBPACK_IMPORTED_MODULE_13__["actionSettingsChangeTheme"]))).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["withLatestFrom"])(this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_4__["select"])(_settings_selectors__WEBPACK_IMPORTED_MODULE_14__["selectEffectiveTheme"]))), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["tap"])(([action, effectiveTheme]) => {
        ...
        this.setTranslateServiceLanguage = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_5__["createEffect"])(() => this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_4__["select"])(_settings_selectors__WEBPACK_IMPORTED_MODULE_14__["selectSettingsLanguage"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["tap"])(language => this.translateService.use(language))), { dispatch: false });
        this.setTitle = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_5__["createEffect"])(() => Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["merge"])(this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_5__["ofType"])(_settings_actions__WEBPACK_IMPORTED_MODULE_13__["actionSettingsChangeLanguage"])), this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["filter"])(event => event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivationEnd"]))).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["tap"])(() => {
            this.titleService.setTitle(this.router.routerState.snapshot.root, this.translateService);
        })), { dispatch: false });
    }
};
SettingsEffects.ctorParameters = () => [
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _settings_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./settings.model */ "./src/app/core/settings/settings.model.ts");
/* harmony import */ var _settings_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./settings.actions */ "./src/app/core/settings/settings.actions.ts");
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm2015/store.js");
...
const selectSettings = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(_core_state__WEBPACK_IMPORTED_MODULE_2__["selectSettingsState"], (state) => state);
const selectSettingsStickyHeader = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectSettings, (state) => state.stickyHeader);
const selectSettingsLanguage = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectSettings, (state) => state.language);
const selectTheme = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectSettings, settings => settings.theme);
const selectPageAnimations = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectSettings, settings => settings.pageAnimations);
const selectElementsAnimations = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectSettings, settings => settings.elementsAnimations);
const selectAutoNightMode = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectSettings, settings => settings.autoNightMode);
const selectNightTheme = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectSettings, settings => settings.nightTheme);
const selectHour = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectSettings, settings => settings.hour);
const selectIsNightHour = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectAutoNightMode, selectHour, (autoNightMode, hour) => autoNightMode && (hour >= 21 || hour <= 7));
const selectEffectiveTheme = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectTheme, selectNightTheme, selectIsNightHour, (theme, nightTheme, isNightHour) => (isNightHour ? nightTheme : theme).toLowerCase());
...
let TitleService = class TitleService {
    ...
    setTitle(snapshot, lazyTranslateService) {
        ...
        if (title) {
            translate
                .get(title)
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(translatedTitle => translatedTitle !== title))
                .subscribe(translatedTitle => this.title.setTitle(`${translatedTitle} - ${_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].appName}`));
        }
        else {
...
let RestApiService = class RestApiService {
    ...
    getLiveEventVideo(getVideo) {
        return this.http.get(this.apiURL + '/live/events/by-url/' + getVideo.eventUrl + '/video/' + getVideo.sessionId, this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["retry"])(1));
    }
    getLiveVideoComments(getComments) {
        console.log('sdkjsadk kjasdnjkasd kjdsanfkjasdfj kjasdnf', getComments);
        if (getComments.cursorId != undefined || getComments.cursorId != null) {
            this.httpOptions.headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('cursor-id', getComments.cursorId);
        }
        else {
            this.httpOptions.headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().delete('cursor-id', getComments.cursorId);
            this.httpOptions.headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json');
        }
        return this.http.get(this.apiURL + '/live/events/by-url/' + getComments.eventUrl + '/comments/' + getComments.sessionId, this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["retry"])(1));
    }
    postLiveVideoComments(postComments) {
    ...
    Subscription API
    ===================*/
    getSubscriptionDetails(eventPurchaseData) {
    ...
    ===================*/
    getLibraryList() {
        return this.http.get(this.apiURL + '/library/home', this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["retry"])(1));
    }
...
let SeoService = class SeoService {
    ...
    generateTags(config) {
        // default values
        config = Object.assign({ title: '', description: '', image: '', slug: '' }, config);
        this.meta.updateTag({ name: 'twitter:card', content: 'Indian arts & literature' });
        this.meta.updateTag({ name: 'twitter:site', content: 'Shaale' });
        this.meta.updateTag({ name: 'twitter:title', content: config.title });
        this.meta.updateTag({ name: 'twitter:description', content: config.description });
        this.meta.updateTag({ name: 'twitter:image', content: config.image });
        this.meta.updateTag({ property: 'og:type', content: 'Indian arts & literature' });
        this.meta.updateTag({ property: 'og:site_name', content: 'Shaale' });
        this.meta.updateTag({ property: 'og:title', content: config.title });
        this.meta.updateTag({ property: 'og:description', content: config.description });
        this.meta.updateTag({ property: 'og:image', content: config.image });
        this.meta.updateTag({ property: 'og:url', content: `https://shaale.com/${config.slug}` });
    }
};
...
let SharedModule = class SharedModule {
    constructor(library) {
        ...
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faBars"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faUserCircle"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faPowerOff"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faCog"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faPlayCircle"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faRocket"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faPlus"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faEdit"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faTrash"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faTimes"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faCaretUp"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faCaretDown"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faExclamationTriangle"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faFilter"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faTasks"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faCheck"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faSquare"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faLanguage"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faPaintBrush"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faLightbulb"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faWindowMaximize"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faStream"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faBook"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faBell"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faSearch"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faAngleDown"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faPhone"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_32__["faPhoneAlt"]);
        library.addIcons(_fortawesome_free_brands_svg_icons__WEBPACK_IMPORTED_MODULE_33__["faGithub"]);
        library.addIcons(_fortawesome_free_brands_svg_icons__WEBPACK_IMPORTED_MODULE_33__["faMediumM"]);
        library.addIcons(_fortawesome_free_brands_svg_icons__WEBPACK_IMPORTED_MODULE_33__["faTwitter"]);
        library.addIcons(_fortawesome_free_brands_svg_icons__WEBPACK_IMPORTED_MODULE_33__["faInstagram"]);
        library.addIcons(_fortawesome_free_brands_svg_icons__WEBPACK_IMPORTED_MODULE_33__["faYoutube"]);
    }
};
...
module.exports = __webpack_require__(/*! /Users/shaale/Desktop/working-project/shaale-ssr/shaale/src/main.ts */"./src/main.ts");
