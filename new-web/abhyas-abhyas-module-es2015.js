...
let AbhyasRoutingModule = class AbhyasRoutingModule {
};
...
let AbhyasModule = class AbhyasModule {
};
...
let AbhyasComponent = class AbhyasComponent {
    constructor(router) {
        this.router = router;
        this.videos = [
            {
...
AbhyasComponent.ctorParameters = () => [
