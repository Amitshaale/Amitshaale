          ...
          !(function(t, o) {
            ...
            (o.prototype.init = function() {
              ...
              e.core.s.autoplayControls && e.controls(),
                ...
                utils.on(e.el, 'onDragstart.lgtm touchstart.lgtm', function() {
              ...
              (o.prototype.progress = function() {
                var e = this,
                  t,
                  o;
                utils.on(e.el, 'onBeforeSlide.lgtm', function() {
                  e.core.s.progressBar &&
                    e.fromAuto &&
                    ((t = e.core.outer.querySelector('.lg-progress-bar')),
                    (o = e.core.outer.querySelector('.lg-progress')),
                    e.interval &&
                      (o.removeAttribute('style'),
                      utils.removeClass(t, 'lg-start'),
                      setTimeout(function() {
                        utils.setVendor(
                          o,
                          'Transition',
              ...
              (o.prototype.controls = function() {
                ...
                e.core.outer
                  ...
                  utils.on(
                    e.core.outer.querySelector('.lg-autoplay-button'),
                    'click.lg',
                    function() {
                      utils.hasClass(e.core.outer, 'lg-show-autoplay')
              ...
              (o.prototype.startlAuto = function() {
                var e = this;
                utils.setVendor(
                  e.core.outer.querySelector('.lg-progress'),
                  'Transition',
                  'width ' + (e.core.s.speed + e.core.s.pause) + 'ms ease 0s'
                ),
                  utils.addClass(e.core.outer, 'lg-show-autoplay'),
                  utils.addClass(
                    e.core.outer.querySelector('.lg-progress-bar'),
                    'lg-start'
                  ),
              ...
              (o.prototype.cancelAuto = function() {
                clearInterval(this.interval),
                  (this.interval = !1),
                  this.core.outer.querySelector('.lg-progress') &&
                    this.core.outer
