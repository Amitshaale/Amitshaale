          ...
          (function(global, factory) {
            ...
            Thumbnail.prototype.build = function() {
              ...
              if (_this.core.s.animateThumb) {
                _this.core.outer.querySelector('.lg-thumb').style.width =
                  _this.thumbTotalWidth + 'px';
                _this.core.outer.querySelector('.lg-thumb').style.position =
                  'relative';
              }
              ...
              if (_this.core.s.dynamic) {
                ...
                for (var i = 0; i < _this.core.items.length; i++) {
                  if (!_this.core.s.exThumbImage) {
                    getThumb(
                      _this.core.items[i].getAttribute('href') ||
                        _this.core.items[i].getAttribute('data-src'),
                      _this.core.items[i]
                        .querySelector('img')
                        .getAttribute('src'),
                      i
              ...
              for (var n = 0; n < $thumb.length; n++) {
                ...
                (function(index) {
                  ...
                  if (vimeoVideoId) {
                    window[
                      'lgJsonP' + _this.el.getAttribute('lg-uid') + '' + n
                    ] = function(content) {
                      $this
                        .querySelector('img')
                        .setAttribute(
                          'src',
                          content[0][_this.core.s.vimeoThumbSize]
                        );
                    };
            ...
            Thumbnail.prototype.enableThumbDrag = function() {
              ...
              utils.on(window, 'mousemove.lgthumb', function(e) {
                if (isDraging) {
                  ...
                  if (
                    tempLeft >
                    _this.thumbTotalWidth - _this.thumbOuterWidth
                  ) {
            ...
            Thumbnail.prototype.toggle = function() {
              ...
              if (_this.core.s.toggleThumb) {
                ...
                utils.on(
                  _this.core.outer.querySelector('.lg-toggle-thumb'),
                  'click.lg',
                  function() {
