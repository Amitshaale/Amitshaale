...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var routes = [
                ...
                {
                    path: '',
                    loadChildren: function () { return __webpack_require__.e(/*! import() | products-products-module */ "products-products-module").then(__webpack_require__.bind(null, /*! ./products/products.module */ "./src/app/products/products.module.ts")).then(function (mod) { return mod.ProductsModule; }); }
                },
                // {
                //   path: '',
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                ...
                AppComponent.prototype.onChangeTheme = function ($event) {
                    console.log($event.checked);
                    if ($event.checked === true) {
                        var theme = 'BLACK-THEME';
                        this.store.dispatch(Object(_core_settings_settings_actions__WEBPACK_IMPORTED_MODULE_4__["actionSettingsChangeTheme"])({ theme: theme }));
                    }
                    else {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AnimationsService = AnimationsService_1 = /** @class */ (function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthEffects = /** @class */ (function () {
                function AuthEffects(actions$, localStorageService, router) {
                    ...
                    this.router = router;
                    this.login = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["createEffect"])(function () { return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["ofType"])(_auth_actions__WEBPACK_IMPORTED_MODULE_6__["authLogin"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.localStorageService.setItem(AUTH_KEY, { isAuthenticated: true }); })); }, { dispatch: false });
                    this.logout = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["createEffect"])(function () { return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["ofType"])(_auth_actions__WEBPACK_IMPORTED_MODULE_6__["authLogout"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var selectAuth = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(_core_state__WEBPACK_IMPORTED_MODULE_2__["selectAuthState"], function (state) { return state; });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            AppErrorHandler.ctorParameters = function () { return [
                    ...
                    return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])({
                        error: function (err) {
                            if (err instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpErrorResponse"]) {
                                var appErrorHandler = _this.injector.get(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ErrorHandler"]);
                    ...
                    return Object.keys(localStorage).reduce(function (state, storageKey) {
                        if (storageKey.includes(APP_PREFIX)) {
                            var stateKeys_1 = storageKey
                                ...
                                .split('-')
                                .map(function (token, index) { return index === 0
                                ? token
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var INIT = Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["of"])('shaale-init-effect-trigger');
            var SettingsEffects = /** @class */ (function () {
                function SettingsEffects(actions$, store, router, overlayContainer, localStorageService, titleService, animationsService, translateService) {
                    ...
                    this.updateTheme = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_5__["createEffect"])(function () { return Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["merge"])(INIT, _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_5__["ofType"])(_settings_actions__WEBPACK_IMPORTED_MODULE_13__["actionSettingsChangeTheme"]))).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["withLatestFrom"])(_this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_4__["select"])(_settings_selectors__WEBPACK_IMPORTED_MODULE_14__["selectEffectiveTheme"]))), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["tap"])(function (_a) {
                        var action = _a[0], effectiveTheme = _a[1];
                        var classList = _this.overlayContainer.getContainerElement()
                            .classList;
                        var toRemove = Array.from(classList).filter(function (item) { return item.includes('-theme'); });
                        if (toRemove.length) {
                            classList.remove.apply(classList, toRemove);
                        }
                        classList.add(effectiveTheme);
                    })); }, { dispatch: false });
                    this.setTranslateServiceLanguage = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_5__["createEffect"])(function () { return _this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_4__["select"])(_settings_selectors__WEBPACK_IMPORTED_MODULE_14__["selectSettingsLanguage"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["tap"])(function (language) { return _this.translateService.use(language); })); }, { dispatch: false });
                    this.setTitle = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_5__["createEffect"])(function () { return Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["merge"])(_this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_5__["ofType"])(_settings_actions__WEBPACK_IMPORTED_MODULE_13__["actionSettingsChangeLanguage"])), _this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["filter"])(function (event) { return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivationEnd"]; }))).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["tap"])(function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm2015/store.js");
            /* harmony import */ var _core_state__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../core.state */ "./src/app/core/core.state.ts");
            var selectSettings = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(_core_state__WEBPACK_IMPORTED_MODULE_2__["selectSettingsState"], function (state) { return state; });
            var selectSettingsStickyHeader = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectSettings, function (state) { return state.stickyHeader; });
            var selectSettingsLanguage = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectSettings, function (state) { return state.language; });
            var selectTheme = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectSettings, function (settings) { return settings.theme; });
            var selectPageAnimations = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectSettings, function (settings) { return settings.pageAnimations; });
            var selectElementsAnimations = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectSettings, function (settings) { return settings.elementsAnimations; });
            var selectAutoNightMode = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectSettings, function (settings) { return settings.autoNightMode; });
            var selectNightTheme = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectSettings, function (settings) { return settings.nightTheme; });
            var selectHour = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectSettings, function (settings) { return settings.hour; });
            var selectIsNightHour = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectAutoNightMode, selectHour, function (autoNightMode, hour) { return autoNightMode && (hour >= 21 || hour <= 7); });
            var selectEffectiveTheme = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectTheme, selectNightTheme, selectIsNightHour, function (theme, nightTheme, isNightHour) { return (isNightHour ? nightTheme : theme).toLowerCase(); });
            /***/ 
        }),
            ...
            var TitleService = /** @class */ (function () {
                ...
                TitleService.prototype.setTitle = function (snapshot, lazyTranslateService) {
                    ...
                    if (title) {
                        translate
                            .get(title)
                            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(function (translatedTitle) { return translatedTitle !== title; }))
                            .subscribe(function (translatedTitle) { return _this.title.setTitle(translatedTitle + " - " + _environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].appName); });
                    }
                    else {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthInterceptor = /** @class */ (function () {
                ...
                AuthInterceptor.prototype.intercept = function (req, next) {
                    var token = localStorage.token; // you probably want to store it in localStorage or something
                    if (!token) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RestApiService = /** @class */ (function () {
                ...
                Library API
                ===================*/
                RestApiService.prototype.getLibraryList = function () {
